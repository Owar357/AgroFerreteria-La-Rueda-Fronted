  <template>
    <DataTable :value="store.categorias" responsiveLayout="scroll" class="p-datatable-custom text-[14px]"
      :paginator="true" :rows="5" :rowsPerPageOptions="[5, 15, 25]" :loading="store.cargando"
