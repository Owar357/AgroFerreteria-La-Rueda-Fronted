<template>
  <div class="bg-[#eef2e9] min-h-screen p-6 font-['Inter',sans-serif]">
    ...
    <div class="flex items-center gap-3 mb-6">
      ...
      <div>
        <h1 class="text-2xl font-bold text-[#1e3a2f]">Reporte de Ventas por Usuario (Cajero)</h1>
        <p class="text-gray-500 text-sm mt-1">Desempeño de ventas registrado por cada cajero.</p>
      </div>
    </div>
...
const generarPDF = async () => {
  ...
  try {
    await generarReporteVentasPorUsuario({
