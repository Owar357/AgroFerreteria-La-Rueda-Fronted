  ...
  <div class="bg-[#eef2e9] min-h-screen p-6 font-['Inter',sans-serif]">
    ...
    <div class="flex items-center gap-3 mb-6">
      <div class="bg-white p-3 rounded-2xl shadow-sm border border-[#e2e8dd]">
        <i class="pi pi-percentage text-[24px] text-[#5F6B52]"></i>
      </div>
      <div>
        <h1 class="text-2xl font-bold text-[#1e3a2f]">Reporte de Margen de Ganancia</h1>
        <p class="text-gray-500 text-sm mt-1">
          PVP, costo promedio ponderado y margen bruto por producto.
        </p>
      </div>
    </div>
