      ...
      >
        ...
        <Column field="activo" header="Estado">
          <template #body="slotProps">
            <span :class="['px-3 py-1 rounded text-[13px] font-semibold uppercase tracking-wide', slotProps.data.activo ? 'bg-[#dff0e0] text-[#2b5e3b]' : 'bg-[#fee2e2] text-[#b91c1c]']">
        ...
        <Column header="Acciones" class="text-center w-[150px]">
          <template #body="slotProps">
            <div class="flex gap-2 justify-center">
              ...
              <Button :icon="slotProps.data.activo ? 'pi pi-eye' : 'pi pi-eye-slash'"
...
.p-inputtext:enabled:focus { box-shadow: 0 0 0 2px rgba(43,94,59,0.2) !important; border-color: #2b5e3b !important; }
</style>