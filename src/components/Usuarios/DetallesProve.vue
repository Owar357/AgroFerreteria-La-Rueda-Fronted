  ...
  <Dialog v-model:visible="visible" modal :closable="false" :style="{ width: '560px' }" :pt="{
    ...
    <div class="flex items-center justify-between px-5 py-4" style="background: #1e3a2f;">
      <div class="flex items-center gap-3">
        ...
        <h2 class="text-white text-base font-semibold m-0 font-inter uppercase tracking-wide">DETALLES DEL PROVEEDOR
        </h2>
      </div>
    ...
    <div class="px-6 py-5 bg-[#eef2e9] font-inter flex flex-col gap-4">
      ...
      <div class="flex items-center justify-between">
        ...
        <span :class="[
          ...
          proveedor?.activo ? 'bg-[#e0b354] text-[#1e3a2f]' : 'bg-[#f2f5ef] text-[#2f573b]'
        ]">
    ...
    <div class="flex justify-center gap-2.5 px-6 py-5 border-t border-[#e2e8dd] bg-[#eef2e9]">
      <Button label="Cerrar" @click="visible = false" :pt="{
      ...
      <Button @click="$emit('open-edit', proveedor)" style="background: #2b5e3b;" :pt="{
