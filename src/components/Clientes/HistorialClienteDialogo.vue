    ...
    <div class="flex justify-between items-start mb-8 pb-5 border-b border-[#e2e8dd]">
      <div class="flex flex-col gap-3">
        ...
        <div class="flex flex-col gap-2">
          <h1
            class="text-[26px] font-bold text-[#1a2e1f] m-0 leading-tight"
          ...
          >
            ...
            <span
              class="text-[18px] text-[#1a2e1f] font-semibold"
              style="font-family: 'Poppins', sans-serif"
            >
              {{ clientName }}
            </span>
    ...
    <div class="border border-[#e2e8dd] rounded-xl overflow-hidden shadow-sm">
      ...
      >
        <template #empty>
          <div
            v-if="!cargando"
            class="flex flex-col items-center justify-center py-10 text-[#6b7280]"
          >
        ...
        <Column field="factura" header="N° Factura">
          <template #body="{ data }">
            ...
            <span v-else class="font-mono font-semibold text-[#1a2e1f]">{{ data.factura }}</span>
          </template>
        </Column>
        ...
        <Column field="date" header="Fecha">
          <template #body="{ data }">
            ...
            <span v-else class="text-[#4b5563]">{{ data.date }}</span>
          </template>
        </Column>
        ...
        <Column field="total" header="Monto Total">
          <template #body="{ data }">
            ...
            <span v-else class="font-semibold text-[#2b5e3b]">${{ data.total.toFixed(2) }}</span>
          </template>
        </Column>
