                ...
                <div class="flex flex-col gap-4">
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="flex flex-col w-4 gap-1.5">
                      <label class="text-[14px] font-medium text-[#1a2e1f]"
                        >Tipo de presentación que entra</label
                      >
                      <Select
                      ...
                      <label class="text-[14px] font-medium text-[#1a2e1f]">
                        ...
                        {{
                          loteForm.presentacionFacturada
                            ? `(en ${loteForm.presentacionFacturada.nombre})`
                            : ''
                        }}
                      </label>
                      <InputText
                    ...
                    <div class="flex flex-col gap-2">
                      ...
                      <div class="flex gap-6 items-center h-[40px]">
                        ...
                        <div class="flex items-center gap-2">
                          ...
                          <label
                            for="noPerecedero"
                            class="cursor-pointer text-[14px] text-[#1a2e1f]"
                            >No perecedero</label
                          >
                        </div>
                      </div>
                      ...
                      <label class="text-[14px] font-medium text-[#1a2e1f]">
                        ...
                        {{
                          loteForm.presentacionBonificada
                            ? `(en ${loteForm.presentacionBonificada.nombre})`
                            : ''
                        }}
                      </label>
                      <InputText
