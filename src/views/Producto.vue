    ...
    <div class="rounded-2xl p-8 mb-6 bg-white border border-[#e2e8dd]">
      ...
      <div class="grid grid-cols-2 gap-6">
        ...
        <div class="flex flex-col gap-2">
          ...
          <AutoComplete v-model="categoria" :suggestions="categoriasFiltradas" optionLabel="nombre"
            dropdown fluid placeholder="Buscar categoría..." @complete="buscarCategorias"
        ...
        <div class="col-span-2 flex flex-col gap-2">
          ...
          <small class="text-[14px] text-gray-500">Se genera automáticamente con las 3 primeras letras del nombre y categoría.</small>
        </div>
      ...
      <div class="grid grid-cols-2 gap-6">
        ...
        <div class="flex flex-col gap-2">
          <label class="text-[20px] font-medium text-gray-600">
            ¿Cuántas
            <span class="bg-[#dff0e0] text-[#1e3a2f] px-2 py-0.5 rounded-full">[{{ unidadBase || 'unidad base' }}]</span>
...
const errores = ref({ nombre: '', categoria: '', unidadBase: '', tipoProducto: '' })
...
const codigoGenerado = computed(() => {
  ...
  return (
    tresPrimeras(catNombre) + tresPrimeras(nombre.value)
  )
})
...
const guardarProducto = async () => {
  // Limpiar errores
  errores.value = { nombre: '', categoria: '', unidadBase: '', tipoProducto: '' }
