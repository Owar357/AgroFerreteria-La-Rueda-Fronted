              ...
              <div class="flex flex-col sm:flex-row sm:items-center p-6 gap-4"
                ...
                <div class="flex flex-col md:flex-row justify-between md:items-center flex-1 gap-6">
                  <div class="flex flex-row md:flex-col justify-between items-start gap-2">
                    <div>
                      <span class="font-medium text-surface-500 white:text-surface-400 text-sm">{{ item.category
                        }}</span>
        ...
        <template #grid="slotProps">
          <div class="grid grid-cols-12 gap-4">
            <div v-for="(item, index) in slotProps.items" :key="index"
              ...
              <div
                class="p-6 border border-surface-200 white:border-surface-700 bg-surface-0 white:bg-surface-900 rounded flex flex-col">
                <div class="bg-surface-50 flex justify-center rounded p-4">
                  <div class="relative mx-auto">
                    ...
                    <Tag :value="item.inventoryStatus" :severity="getSeverity(item)"
                      class="absolute white:bg-surface-900!" style="left: 4px; top: 4px"></Tag>
                  </div>
                </div>
                <div class="pt-6">
