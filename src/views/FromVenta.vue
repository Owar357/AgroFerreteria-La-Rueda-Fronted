        ...
        <div class="flex flex-col gap-4 flex-1 overflow-y-auto">
          ...
          <div class="flex flex-col gap-1.5">
            ...
            <div class="relative">
              ...
              <i
                class="pi pi-chevron-down absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none"
          ...
          <div class="flex flex-col gap-1.5">
            ...
            <InputText
              ...
              placeholder="Escribe nombre o cód. interno..."
              class="w-full"
          ...
          <div class="flex flex-col gap-1.5">
            <label style="font-size: 13px; font-weight: 500; color: #4b5563"
              >Elegir presentación a vender</label
            >
        ...
        <div class="flex flex-col gap-4 flex-1">
          ...
          <div class="flex flex-col gap-1.5">
            ...
            <p style="font-size: 12px; color: #2b5e3b; margin: 0">
              Nombre:
              <span style="color: #6b7280; font-style: italic">{{ nombreCliente || '—' }}</span>
            </p>
          </div>
          ...
          <div class="flex flex-col gap-1.5">
            ...
            <div class="relative">
              <select
                v-model="tipoPago"
                class="w-full outline-none appearance-none cursor-pointer"
                style="
                  background-color: #ffffff;
                  border: 1px solid #d1d5db;
                  border-radius: 10px;
